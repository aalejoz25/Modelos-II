...
function dibujarFlappy(){
  contexto.drawImage(imgAveA,0,0,38,26,150,flappy.y,38,26);
}
...
function puntuacion(){
    ...
    /* var nombre = prompt("Please enter your name", "");
  		var url = "http://localhost/Nueva%20pagina/juegos/FlappyBird/guardar.php";
	var data = {puntaje:contador,nombre:nombre}; */
  			fetch(url, {
  			method: 'POST', // or 'PUT'
